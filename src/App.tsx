          ...
          <div className="min-w-0 flex-1 pb-16 pt-12">
            <div className="flex flex-col items-start gap-11 px-4">
              ...
              <div className="flex flex-col items-start gap-3">
                <h1 className="-ml-[0.045em] w-full max-w-none text-left text-[clamp(2.75rem,6.8vw,5.5rem)] italic font-medium leading-[0.96] tracking-tight text-neutral-900 dark:text-stone-50" style={{ fontFamily: "Junicode" }}>
                          ...
                          <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                              ...
                              {locationLabels.length > 0 ? (
                                <div className="mt-0.5 flex flex-wrap items-center gap-2 text-[14px] text-neutral-500 dark:text-stone-400">
            ...
            <div className="pt-6">
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className={cn(
                    "relative inline-flex h-7 w-12 shrink-0 rounded-full bg-neutral-200 transition-colors dark:bg-stone-700",
