...
const serviceAliases = {
  "Tracks / Silk press + tracks": "Tracks / Silk press + tracks / Invisible sew-in",
  "Tracks (per row)": "Tracks / Silk press + tracks / Invisible sew-in",
  "Rows of tracks": "Tracks / Silk press + tracks / Invisible sew-in",
  "Rows of Tracks": "Tracks / Silk press + tracks / Invisible sew-in",
  "Silk press + tracks": "Tracks / Silk press + tracks / Invisible sew-in",
  "Silk press with tracks": "Tracks / Silk press + tracks / Invisible sew-in",
  "Invisible sew-in": "Tracks / Silk press + tracks / Invisible sew-in",
  "Invisible sew in": "Tracks / Silk press + tracks / Invisible sew-in",
  "Invisible sewin": "Tracks / Silk press + tracks / Invisible sew-in",
  "Invisible sew-ins": "Tracks / Silk press + tracks / Invisible sew-in",
  "Invisible sew ins": "Tracks / Silk press + tracks / Invisible sew-in",
