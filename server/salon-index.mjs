...
export const categoryMap = {
  ...
  "wig-services": ["Wig install (frontal / closure)", "Wig colouring / bundle colouring", "Custom wig", "U-part wig install", "Pixie wig / weave install"],
  "extension-services": ["K-tips / invisible strands", "LA weave", "Tape ins", "Microlinks", "Clip ins (+ silk press)"],
  ...
  "natural-hair-scalp-health": [
    "Healthy hair plans & consultations",
    "Natural hair coaches / educators",
    "Trichology / scalp analysis",
  ],
  "colour-services": ["Full head colour", "Highlights", "Balayage", "Wig colouring / bundle colouring"],
  "styling-services": ["Extensions blowdry", "Sleek ponytail / bun", "Frontal ponytail / bun", "Half up half down", "Pixie / finger waves", "Updo"],
};
...
export const serviceAliases = {
  ...
  "Dolly braids": "Creative braids (e.g. patewo)",
  "Dolly Braids": "Creative braids (e.g. patewo)",
  Shuku: "Creative braids (e.g. patewo)",
  shuku: "Creative braids (e.g. patewo)",
  "Koroba braids": "Creative braids (e.g. patewo)",
  "Koroba Braids": "Creative braids (e.g. patewo)",
  ...
  "Extensions blowdry": "Extensions blowdry",
  "Extensions blowout": "Extensions blowdry",
  "Extension blowdry": "Extensions blowdry",
  "Extension blowout": "Extensions blowdry",
  "Blowdry with extensions": "Extensions blowdry",
  "Blow dry with extensions": "Extensions blowdry",
  "Blowout with extensions": "Extensions blowdry",
  "Blow out on sew in weave": "Extensions blowdry",
  "Blowout on sew in weave": "Extensions blowdry",
  "Wash and blowdry with extensions": "Extensions blowdry",
  "Wash and blow dry with extensions": "Extensions blowdry",
  "Wash & blowdry with extensions": "Extensions blowdry",
  "Wash & Blow dry with Extensions": "Extensions blowdry",
